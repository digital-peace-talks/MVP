<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Conflict.aspx.cs" Inherits="DigitalPeaceTalks.Conflict" %>
...
<head runat="server">
    ...
    <title>Digital Peace Talks|Conflict</title>
...
<body>
        ...
        <div id="wrapper">
            <div id="page-wrapper" class=" white-bg" style="margin: 0 0 0 0px; padding: 0 0px;">
                ...
                <div class="wrapper wrapper-content animated fadeInRight" style="padding: 20px 10px 10px;">
                    ...
                    <div class="row brdr">
                        <div class="col-2">
                             <a onclick="openModal10('<%=Request.QueryString["id"].ToString() %>');">See the halted chat</a>
                        </div>
                        ...
                        <%-- <a class="mysignupbtn" style="height: 30px; width: 180px; background-color: #1ab394; color: white">Resolve</a>--%>
                        <asp:LinkButton ID="btnResolve" runat="server" CssClass="mysignupbtn" Style="height: 30px; width: 80px; background-color: #1ab394; margin-left: 10px;" OnCommand="btnResolve_Command">Resolve</asp:LinkButton>
                        <asp:LinkButton ID="btnEnd" runat="server" CssClass="mysignupbtn" Style="height: 30px; width: 50px; background-color: #ed5565; margin-left: 10px;" OnCommand="btnEnd_Command" >End</asp:LinkButton>
                    </div>
    ...
    <script type="text/javascript">
        function openModal10(str) {
            $('#myModal10').modal('show').find('.modal-body').load('ChatView.aspx?Cid='+ str);
        }
